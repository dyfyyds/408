...
- 本页归入 [[wiki/408专业课/计算机组成原理/中央处理器|中央处理器]]，重点连接 [[wiki/concepts/计算机组成原理/第5章 中央处理器/指令执行过程|指令执行过程]]、[[wiki/concepts/计算机组成原理/第5章 中央处理器/数据通路|数据通路]]、[[wiki/concepts/计算机组成原理/第5章 中央处理器/控制器|控制器]]。
